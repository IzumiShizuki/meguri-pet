...
| M-012 | Implemented; staging evidence blocked | `9127f2d`, `b77d4ab`, `26c8859` | Read-only recovery and required fixed-recall validator, native workflow integration suite, deterministic exact/ANN harness, secret-file environment contract, pinned release metadata and delivery reports | Offline migration/recovery/benchmark tests pass. Live database, backup restore and fixed-corpus execution skip because no test/staging connection or restored target was handed off |
